import svgPaths from "./svg-i0jjn08my5";

function IconTablerIconsMail({ className }: { className?: string }) {
  return (
    <div className={className || "absolute h-[55.35px] left-[calc(33.33%+135.62px)] overflow-clip top-[238px] w-[60.75px]"} data-name="icon / tabler-icons / mail">
