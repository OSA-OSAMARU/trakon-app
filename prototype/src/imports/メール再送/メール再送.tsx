import svgPaths from "./svg-ai0bw7vwft";
...
export default function Component() {
  return (
    <div className="bg-white border border-black border-solid relative size-full" data-name="メール再送">
      ...
      <p className="-translate-x-1/2 absolute font-['Noto_Sans:Medium','Noto_Sans_Symbols:Regular','Noto_Sans_JP:Regular',sans-serif] font-medium leading-[0] left-[calc(33.33%+166.33px)] text-[#696969] text-[10px] text-center top-[493px] tracking-[0.8px] whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        <span className="font-['Noto_Sans:Regular','Noto_Sans_Symbols:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[normal]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          ✓再送しました。次の再送まで
        </span>
        <span className="leading-[normal]">{` `}</span>
        <span className="font-['Noto_Sans:Bold','Noto_Sans_Symbols:Regular','Noto_Sans_JP:Regular',sans-serif] font-bold leading-[normal]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
          58
        </span>
        <span className="leading-[normal]">{` `}</span>
        <span className="font-['Noto_Sans:Regular','Noto_Sans_Symbols:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[normal]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
