...
export function ProjectCreatePage() {
  ...
  const [participants, setParticipants] = useState<Participant[]>([
    { id: "1", name: "", organization: "", email: "", type: "production" },
    { id: "2", name: "", organization: "", email: "", type: "production" },
    { id: "3", name: "", organization: "", email: "", type: "client" },
  ]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    navigate("/projects/1/deliverables/1");
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white border border-border rounded-lg p-6">
            <div className="flex items-center justify-between mb-6">
              <h3>制作物 <span className="text-destructive">*</span></h3>
              <button
                type="button"
