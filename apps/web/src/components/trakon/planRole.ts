...
export const PLAN_ROLE_SPEC: Record<PlanRole, { label: string; avatar: string }> = {
  executor: { label: '実施者', avatar: 'bg-role-executor' },
  approver: { label: '承認者', avatar: 'bg-role-approver' },
  manager: { label: '進行責任者', avatar: 'bg-role-manager' },
};
